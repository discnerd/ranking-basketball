#setwd("C:/Users/mr437799/Dropbox/Current/Data Projects/Basketball Ranking")
#setwd("C:/Users/Matt/Dropbox/Current/Data Projects/Basketball Ranking/")
...
scores <- read.csv("http://www.masseyratings.com/scores.php?s=292155&sub=11590&all=1&mode=3&format=1", header=FALSE)
teams <- read.csv("http://www.masseyratings.com/scores.php?s=292155&sub=11590&all=1&mode=3&format=2", header=FALSE)
...
write.csv(rankings, paste("Womens Basketball-D1 MOV RW ", format(Sys.time(),"%Y %m %d"),".csv",sep=""), row.names = FALSE)
